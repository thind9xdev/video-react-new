...
describe('PlayProgressBar', () => {
  it('should render with "div" tag', () => {
    ...
    expect(wrapper.find('div.video-react-new-play-progress').length).toBe(1);
  });

  it('should render with "video-react-new-play-progress" class', () => {
    const wrapper = shallow(
      <PlayProgressBar currentTime={10} duration={1000} />
    );
    expect(wrapper.hasClass('video-react-new-play-progress')).toBe(true);
  });
