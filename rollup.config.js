...
function baseConfig() {
  return {
    input: 'src/video-react-new.ts',
    plugins: [
      sass({
        output: 'dist/video-react-new.css',
      }),
      nodeResolve({
...
libConfig.output = [
  {
    ...
    file: 'dist/video-react-new.cjs.js',
    format: 'cjs',
  },
  {
    sourcemap: true,
    name: 'video-react-new',
    file: 'dist/video-react-new.es.js',
    format: 'es',
  },
];
...
/*
  ...
  video-react-new has two versions:

  1) `video-react-new.min.js`
...
umdFullConfig.output = [
  {
    ...
    sourcemap: true,
    name: 'video-react-new',
    file: 'dist/video-react-new.full.js',
    format: 'umd',
  },
];
...
umdFullConfigMin.output = [
  {
    ...
    sourcemap: true,
    name: 'video-react-new',
    file: 'dist/video-react-new.full.min.js',
    format: 'umd',
  },
];
...
umdConfigMin.output = [
  {
    ...
    sourcemap: true,
    name: 'video-react-new',
    file: 'dist/video-react-new.min.js',
    format: 'umd',
  },
];
