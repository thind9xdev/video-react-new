        ...
        <Container>
          <Row>
            <Col>
              ...
              <h1 className="jumbotron-heading display-4">video-react-new</h1>
              <p className="lead">
              ...
              <p>
                <Button
                  outline
                  color="danger"
                  href="https://github.com/video-react-new/video-react-new"
                >
                  View on Github
                </Button>
      ...
      <Container fluid>
        <Row>
          <Col sm={{ size: 8, offset: 2 }}>
            ...
            <hr />
            <h3>NPM</h3>
            <p>Install video-react-new and peer dependencies via NPM</p>
            <pre>
              <PrismCode className="language-bash">
                npm install --save video-react-new react react-dom redux
              </PrismCode>
            </pre>
            <h3>Basic example</h3>
            ...
            <p>import css in your app or add video-react-new styles in your page</p>
            <pre>
              <PrismCode className="language-jsx">
                import "node_modules/video-react-new/dist/video-react-new.css"; //
                import css
              </PrismCode>
            </pre>
            <pre>
              <PrismCode className="language-jsx">
                @import "~video-react-new/styles/scss/video-react-new"; // or import
                scss
              </PrismCode>
            </pre>
            <pre>
              <PrismCode className="language-html">
                &lt;link rel="stylesheet" href="/css/video-react-new.css" /&gt;
              </PrismCode>
            </pre>
            <pre>
