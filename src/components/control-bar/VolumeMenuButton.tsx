    ...
    <PopupButton
      ...
      className={classNames(
        className,
        {
          ...
          'video-react-new-vol-0': volumeLevel === 0 && !player.muted,
          'video-react-new-vol-1': volumeLevel === 1,
          'video-react-new-vol-2': volumeLevel === 2,
          'video-react-new-vol-3': volumeLevel === 3,
          'video-react-new-slider-active': alwaysShowVolume || active,
          'video-react-new-lock-showing': alwaysShowVolume || active,
        },
