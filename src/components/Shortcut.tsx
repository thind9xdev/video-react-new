...
export default class Shortcut extends Component<ShortcutProps> {
  ...
  handleKeyPress(e: KeyboardEvent) {
    ...
    if (
      ...
      (hasClass(activeElement, 'video-react-new-control') ||
        hasClass(activeElement, 'video-react-new-menu-button-active') ||
        hasClass(activeElement, 'video-react-new-big-play-button'))
    ) {
      return;
    }
